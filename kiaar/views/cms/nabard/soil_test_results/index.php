                ...
                <div class="form-body">
                    <div class="portlet-title tabbable-line">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject font-brown bold uppercase">Soil Test Results</span>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <span class="custorange">
                                        <a class="sizebtn btn sbold orange" href="<?php echo base_url('cms/soil_test_results/edit'); ?>">Add New
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Date</label>
                                    <div class="date_wrap">
                                        <input type="text" class="datetextbox wid60date form-control" id="date" name="date" />
                                        <!-- <select class="select2 form-control custom-select" name="date" id="date" style="width: 100%;" data-placeholder="-- Select Date --">
...
<script type="text/javascript">
    ...
    function get_farmername_options() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url : base_url+'cms/soil_test_results/get_farmername_options_url/',
            data: {},
    ...
    //         type: "POST",
    //         dataType: "json",
    //         url : base_url+'cms/soil_test_results/get_year_options_url/',
    //         data: {},
    //         success: function(response) {
    ...
    function initTable() {
        $('#dataTableId').bootstrapTable({
            url: base_url+'cms/soil_test_results/farmer_ajax_list',
            method: 'GET',                
            ...
            exportOptions: { ignoreColumn: ['action'], fileName: 'soil_test_results' },
            showExport: true,
            exportDataType: 'all',
...
function change_status(id) {
        ...
        if(id != '')
        {
            ...
            swal({
                ...
                if(result)
                {
                    window.location.href = base_url+'cms/soil_test_results/delete/'+id;
                }
            }, function(dismiss) {});
        }
    }
