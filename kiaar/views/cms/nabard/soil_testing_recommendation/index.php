                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <span class="custorange">
                                        <a class="sizebtn btn sbold orange" href="<?php echo base_url('cms/soil_testing_recommendation/edit'); ?>">Add New
...
<script type="text/javascript">
    ...
    function get_farmername_options() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url : base_url+'cms/soil_testing_recommendation/get_farmername_options_url/',
            data: {},
    ...
    function initTable() {
        $('#dataTableId').bootstrapTable({
            url: base_url+'cms/soil_testing_recommendation/ajax_list',
            method: 'GET',                
            ...
            exportOptions: { ignoreColumn: ['action'], fileName: 'soil_testing_recommendation' },
            showExport: true,
            exportDataType: 'all',
...
function change_status(id) {
        ...
        if(id != '')
        {
            ...
            swal({
                ...
                if(result)
                {
                    window.location.href = base_url+'cms/soil_testing_recommendation/delete/'+id;
                }
            }, function(dismiss) {});
        }
    }
