            ...
            <div class="portlet light ">
                <div class="portlet-title tabbable-line">
                    <div class="caption caption-md">
                        ...
                        <span class="caption-subject font-brown bold uppercase">Pages</span>
                    </div>
                </div>
                            ...
                            <?php foreach($data_list as $data){ ?>
                                <tr class="gradeX">
                                    ...
                                    <td class="actbtn">
                                        ...
                                        <a href="<?php echo base_url();?>en/<?=$data["slug"]?>" class="btn custblue btn-sm" title="<?=_l('Preview',$this)?>" target="_blank"><i title="<?=_l('Preview',$this)?>" class="icon-eye"></i></a>
