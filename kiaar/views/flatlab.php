...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?=base_url()?>assets/kiaar_general/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?=base_url()?>assets/newsticker/ticker-style.css" rel="stylesheet">
    <link href="<?=base_url()?>assets/kiaar_general/css/style.css" rel="stylesheet">
    <link href="<?=base_url()?>assets/kiaar_general/css/frontend-style.css" rel="stylesheet">
<!--    <link href="--><?//=base_url()?><!--assets/kiaar_general/css/news-style-blue.css" rel="stylesheet">-->
    <!--external css-->
    <link href="<?=base_url()?>assets/flatlab/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />


    <?php if($_SESSION["language"]["rtl"]==1){ ?>
        <link href="<?=base_url()?>assets/kiaar_general/css/rtl.css" rel="stylesheet">
    <?php } ?>
    <?php if($_SESSION["language"]["code"]=="fa"){ ?>
        <link href="<?=base_url()?>assets/flatlab/fonts_fa/ed-fonts.css" rel="stylesheet">
    <?php } ?>

    <script src="<?=base_url()?>assets/kiaar_general/js/jquery-1.11.3.min.js"></script>
...
<body>
    ...
    <script src="<?=base_url()?>assets/kiaar_general/js/bootstrap.min.js"></script>
    <script type="text/javascript">
