            ...
            <div class="soiltest-content">
                ...
                <div class="about-test">
                  <?php if($farmers['date'] != '') { ?>
                    <div class="user-info-data test-info">
                      <div class="text">Soil Testing Date:</div>
                      <div class="text-value"><?=$farmers['date']?></div>
                    </div>
                  <?php } ?>
                  <div class="user-info-data test-info">
                  ...
                  <?php if($farmers['sampledate'] != '') { ?>
                    <div class="user-info-data test-info">
                      <div class="text">Sample Date:</div>
                      <div class="text-value"><?=$farmers['sampledate']?></div>
                    </div>
                  <?php } ?>
                </div>
                <div class="about-test">
                  ...
                  <?php } ?>
                  <?php if($farmers['plot_no'] != '') { ?>
                    <div class="user-info-data test-info">
                      <div class="text">Plot No:</div>
                      <div class="text-value"><?=$farmers['plot_no']?></div>
                    </div>
                  <?php } ?>
                  <?php if($farmers['plot_area'] != '') { ?>
                    <div class="user-info-data test-info">
                      <div class="text">Area:</div>
                      <div class="text-value"><?=$farmers['plot_area']?></div>
                    </div>
                  <?php } ?>
              ...
              <div class="">
                <div class="soil-data1">
                  <?php if($farmers['test_values'][0] != '') { ?>
                    <div class="table-data table-responsive">
                      <table class="table border-table og-table">
                        <thead>
                          <tr>
                            <th class="tbmainsubhead">Sr.no.</th>
                            <th class="tbmainsubhead">Details</th>
                            <th class="tbmainsubhead">Test Value</th>
                            <th class="tbmainsubhead">Unit</th>
                            <th class="tbmainsubhead">Range</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php $j=1; foreach ($farmers['test_values'] as $keynew => $valuenew) { ?>
                            <?php 
                              $standard_range = $valuenew['standard_range'];
                              //Using the explode method
                              $arr_ph = explode("-",$standard_range);
                              $maxrange = $arr_ph[1];
                              $minrange = $arr_ph[0];
                            ?>
                            <tr>
                              <td><?=$j?></td>
                              <td><?=$valuenew['parameter_name']?></td>
                              <td class="text-right"><?php if($valuenew['parameter_value'] > $maxrange OR $valuenew['parameter_value'] < $minrange) { ?>
                                <b><?=$valuenew['parameter_value']?><b><?php } else { ?><?=$valuenew['parameter_value']?><?php } ?></td>
                              <td><?=$valuenew['measure_unit']?></td>
                              <td class="text-right"><?=$valuenew['standard_range']?></td>
                            </tr>
                          <?php $j++; } ?>
                        </tbody>
                      </table>
                  ...
                  <?php } ?>
                  <?php if($farmers['s3_link'] != '') { ?>
                    <div class="float-right"><a class="green-link" href="<?php echo $farmers['s3_link']; ?>" target="_blank" title="open in pdf">Soil Test Recommendation Report</a></div>
                  <?php } ?>
                </div>
