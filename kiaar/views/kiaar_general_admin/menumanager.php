        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-brown bold uppercase">Insert MainMenu <?= "- ". $institutes_details['INST_NAME'] ?>  (<?= $institutes_details['INST_SHORTNAME']?>)</span>
                </div>
            </div>
              <?php 
            ...
            <div class="portlet-body form">
                <?php mk_hpostform($base_url.$page."_manipulate".(isset($data['menu_id'])?"/".$data['menu_id']:"")); ?>
                    <div class="form-body">
                        ...
                        // mk_hselect("data[institute_id]",_l('Select Institute',$this),$institutes,"institute_id","institute_name",isset($data['institute_id'])?$data['institute_id']:null,""._l("Select Institute",$this)."");
    ...
    <div class="col-md-6">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-social-dribbble font-brown"></i>
                    <span class="caption-subject font-brown bold uppercase">Main Menu List</span>
                </div>
            </div>
            <div class="portlet-body form">
                <div class="portlet-body flip-scroll">
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tbody>
                            <?php 
                            $i=0; foreach($data_list as $item){ $i++; ?>
                                <tr>
